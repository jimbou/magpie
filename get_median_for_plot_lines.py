...
def process_files(root_dir):
    ...
    grouped_by_item[['total_decreases','average_decrease_percentage_per_step', 'std_deviation_of_decreases', 'proportion_of_large_decreases']].to_csv(f'{root_dir}/fitness_analysis_grouped_by_item.csv')
