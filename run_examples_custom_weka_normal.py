...
def main(name1, scenario ,name3, compile_command, improved_file, main_directory, params_file,search_type='local_search'):
    ...
    perf_items = [ "energy","perf_L1_dcache_loads", "weights", "time","perf_cache_misses", "perf_branches" ]
    perf_items = [ "energy", "weights" ]

    # weights 4, perf_L1_dcache_loads 3, time 4, perf_cache_misses 4, perf_branches 5
    retry_attempts = {     # Retries for item1 at attempts 1, 2, and 3
    'energy': [1],
    'weights': [4],
    'perf_L1_dcache_loads':[3],
    'time':[4],
    'perf_cache_misses': [4],
    'perf_branches': [5]
    ...
    for item in perf_items:
        ...
        try:
            for retries_num in retry_attempts[item]:
