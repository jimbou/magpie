...
def process_json(json_file_path):
    ...
    for element in data['items']:
        ...
        improvement_ratio = find_largest_improvement_ratio(fitness_values)
    ...
    return item_name_median_dict, retries_median_dict
...
if __name__ == "__main__":
    ...
    item_name_median_dict, retries_median_dict = process_json(json_file_path)
    
    # Get directory of the JSON file
    json_dir = os.path.dirname(json_file_path)
    
    # Create file paths for the CSV files
    item_name_csv_path = os.path.join(json_dir, 'largest_improvement_ration_per_metric.csv')
    retries_csv_path = os.path.join(json_dir, 'largest_improvement_ration_per_retry.csv')
